  ...
  return (
    <div className="bg-gradient-to-r from-red-900 to-red-600 h-screen flex flex-col gap-4 items-center justify-center w-full">
      ...
      <div className=" fixed inset-x-0  h-[66%] bg-white bottom-0 p-8 rounded-t-2xl shadow-md w-full ">
        <h2 className="text-2xl text-red-700  font-bold mb-2 text-center">SIGN UP</h2>
        <div className="">
        ...
        <div className="">
          <label htmlFor="phone" className="block text-red-600 text-md font-bold mb-2">Phone</label>
          <input type="text" id="phone" className="shadow appearance-none border border-red-600 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
        </div>
        <div className="">
        ...
        <div className="mb-2">
          <label htmlFor="password" className="block text-red-600 text-md font-bold mb-2">Confirm Password</label>
          <input type="password" id="c-password" className="shadow appearance-none border border-red-600 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" />
        </div>
        ...
        <div className="text-center my-4 text-red-700 font-bold">OR SIGN UP WITH</div>
        ...
        <div className="text-center">
            <p className="inline-block align-baseline font-bold text-lg text-red-600">Already a user? </p>
            <br />
